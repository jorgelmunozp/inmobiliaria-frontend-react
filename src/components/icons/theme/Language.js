export const Language = ({ color='currentColor', className='', strokeWidth='1', width='1', height='1'}) => {
    return (
            <svg className={className} stroke={color} fill="none" strokeWidth={strokeWidth} viewBox="0 0 24 24" aria-hidden="true" height={height + 'em'} width={width + 'em'} xmlns="http://www.w3.org/2000/svg">
