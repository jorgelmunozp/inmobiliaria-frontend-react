export const Dollar = ({ strokeWidth='0', width='1em', height='1em'}) => {
    return (
        <span>
            <svg stroke="currentColor" fill="currentColor" strokeWidth={strokeWidth} viewBox="0 0 256 256" height={height} width={width} xmlns="http://www.w3.org/2000/svg">
