export const Area = ({ color="currentColor", strokeWidth='0', width='1', height='1'}) => {
    return (
        <span>
            <svg stroke={color} fill={color} strokeWidth={strokeWidth} xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24" width={width + 'em'} height={height + 'em'}>
