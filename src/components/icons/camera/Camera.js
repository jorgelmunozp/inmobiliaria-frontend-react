export const Camera = ({strokeWidth='32', width='1em', height='1em'}) => {
    return (
        <span>
            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" height={height} width={width} xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="256" cy="272" r="80" fill="none" stroke-miterlimit="10" strokeWidth={strokeWidth}></circle>
