export const SortDown = ({ strokeWidth='0', width='1', height='1'}) => {
    return(
        <span>
            <svg stroke="currentColor" fill="currentColor" strokeWidth={strokeWidth} version="1" viewBox="0 0 48 48" enable-background="new 0 0 48 48" height={height + 'em'} width={width + 'em'} xmlns="http://www.w3.org/2000/svg">
