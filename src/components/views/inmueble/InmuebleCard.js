                    ...
                    <div className='row no-gutters'>
                        <div>
                            <div>
                                ...
                                <div className='badge bg-dark-transparent-color bg-gradient text-white fw-bolder position-absolute end-0 bottom-0 w-100 h-35'>
                                    <h5 className='badge text-white fw-bolder position-absolute start-0'><small>{ detalle.categoria }</small></h5>
                                    <h5 className='badge text-white fw-bolder position-absolute end-0'><small>{ detalle.tipo }</small></h5>
