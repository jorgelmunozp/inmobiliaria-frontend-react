                        ...
                        <div>
                            <div>
                                ...
                                <div className='badge bg-dark-transparent-color bg-gradient text-center text-white fw-bolder position-absolute end-0 bottom-0 w-100 h-35'>
                                    <h4 className='badge text-white fw-bolder position-absolute start-0'><small>{ detalle.categoria }</small></h4>
                                    <h4 className='badge text-white fw-bolder position-absolute end-0'><small>{ detalle.tipo }</small></h4>
