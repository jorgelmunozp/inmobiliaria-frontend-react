                            ...
                            <div className='card-body px-3'>
                                ...
                                <div className='card-text lh-base'>
                                    <ul className='list-group list-group-horizontal justify-content-between'>
                                        <li className='list-group-item fw-bolder border-white text-center p-0'><Area strokeWidth={0.75} width={1.65} height={1.65} /> <span className='text-muted fw-bolder px-1'>{ detalle.area }&nbsp;<small>m<sup>2</sup></small></span></li>
                                        <li className='list-group-item fw-bolder border-white text-center p-0'><Bed strokeWidth={44} width={1.5} height={1.5} /> <span className='text-muted fw-bolder px-1'>{ detalle.habitaciones }</span></li>
                                        <li className='list-group-item fw-bolder border-white text-center p-0'><Bath strokeWidth={0.5} width={1.3} height={1.5} /> <span className='text-muted fw-bolder px-1'>{ detalle.baños }</span></li>
                                        <li className='list-group-item fw-bolder border-white text-center p-0'><Car strokeWidth={44} width={1.5} height={1.5} /> <span className='text-muted fw-bolder px-1'> { detalle.parqueaderos }</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
