...
const Camera = lazy(() => import('../../icons/camera/Camera.js'));
const Car = lazy(() => import('../../icons/car/Car.js'));
const Category = lazy(() => import('../../icons/category/Category.js'));
const HomeWarehouse = lazy(() => import('../../icons/home/HomeWarehouse.js'));
const Description = lazy(() => import('../../icons/description/Description.js'));
const Home = lazy(() => import('../../icons/home/Home.js'));
const HomeDollar = lazy(() => import('../../icons/home/HomeDollar.js'));
const ImageSearch = lazy(() => import('../../icons/image/ImageSearch.js'));
const LocationArrow = lazy(() => import('../../icons/location/LocationArrow.js'));
const MapLocation = lazy(() => import('../../icons/map/MapLocation.js'));
const MapPin = lazy(() => import('../../icons/map/MapPin.js'));
const Type = lazy(() => import('../../icons/type/Type.js'));
const HomeQuestion = lazy(() => import('../../icons/home/HomeQuestion.js'));
const Image = lazy(() => import('../../icons/image/Image.js'));
