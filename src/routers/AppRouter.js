  ...
  return (
    <Router basename={"/" + urlBaseFrontend} future={{ v7_relativeSplatPath: true, v7_startTransition: true, }}>
      ...
      <div className="user-select-none">
        <Routes>
          <Route path={"*"} element={ <PublicRoute urlApiInmuebles={urlApiInmuebles} categorias={categorias} tipos={tipos} estados={estados} caracteristicas={caracteristicas} paises={countries}><IndexScreen Logo={Logo} inmuebles={inmuebles} /></PublicRoute> } />
          <Route path={"/"} element={ <PublicRoute urlApiInmuebles={urlApiInmuebles} categorias={categorias} tipos={tipos} estados={estados} caracteristicas={caracteristicas} paises={countries}><IndexScreen Logo={Logo} inmuebles={inmuebles} /></PublicRoute> } />
          <Route path={"/*"} element={ <PublicRoute urlApiInmuebles={urlApiInmuebles} categorias={categorias} tipos={tipos} estados={estados} caracteristicas={caracteristicas} paises={countries}><IndexScreen Logo={Logo} inmuebles={inmuebles} /></PublicRoute> } />
          <Route path={"/inicio"} element={ <PublicRoute urlApiInmuebles={urlApiInmuebles} categorias={categorias} tipos={tipos} estados={estados} caracteristicas={caracteristicas} paises={countries}><IndexScreen Logo={Logo} inmuebles={inmuebles} /></PublicRoute> } />
          <Route path={"/apartamentos"} element={ <Suspense fallback={<center><div className="loader"></div></center>}><PublicRoute urlApiInmuebles={urlApiInmuebles} categorias={categorias} tipos={tipos} estados={estados} caracteristicas={caracteristicas} paises={countries}><ApartamentosScreen inmuebles={inmuebles} /></PublicRoute></Suspense> } />
          ...
          <Route path={"/login"} element={ <Suspense fallback={<center><div className="loader"></div></center>}><PublicRoute urlApiInmuebles={urlApiInmuebles} categorias={categorias} tipos={tipos} estados={estados} caracteristicas={caracteristicas} paises={countries}><LoginScreen Logo={Logo} AuthContext={AuthContext} types={types} myTitle={myTitle} myColor={myColor} /></PublicRoute></Suspense> } />
