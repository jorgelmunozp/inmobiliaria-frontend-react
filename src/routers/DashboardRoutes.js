...
export const DashboardRoutes = ({ urlBaseFrontend, urlApiInmuebles, categorias, tipos, estados }) => {
  ...
  return (
    <div className="container user-select-none">
      <Routes>
          ...
          <Route path={urlBaseFrontend + "/upload"} element={<InmuebleUpload inmuebles={inmuebles} urlApiInmuebles={urlApiInmuebles} urlBaseFrontend={urlBaseFrontend} categorias={categorias} tipos={tipos} estados={estados}/>} />
